...
//        });
        ...
        regi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String fullNameRegex = "^[a-zA-Z]{4,}(?: [a-zA-Z]+){0,2}$";
                ...
                if (!Pattern.matches(nameRegex, userName)) {
                ...
                } else if (!Pattern.matches(fullNameRegex, fullName)) {
                    ...
                    String queryInsert = "INSERT INTO `doctors`( `uname`, `fulname`, `email`, `phone`, `pass`, `age`) VALUES ('" + userName + "','" + fullName + "''" + email + "'," +
                            "'" + Pass + "','" + phone + "','" + age + "')";
                    db.RegisterUser(queryInsert);
                }
